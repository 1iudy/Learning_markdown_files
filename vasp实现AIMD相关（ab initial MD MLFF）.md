...
### 核回归
对于需要学习的构型数据集$(\rho_{i_B},\, U_{i_B}^{\text{ref}})$，学习泛函关系$U_i = F[\rho_i(\mathbf{r})]$ ，使用核回归方法：将 $F$ 写成核的线性组合，即 $F$ 处在数据集构型所zhang'cheng
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjU3MDUxMTg2LDI3ODY0OTA0MiwxMzMwMT
QzODU0LC0yMzM3MjQ4MDIsMTAwNjMwODI0Ml19
-->