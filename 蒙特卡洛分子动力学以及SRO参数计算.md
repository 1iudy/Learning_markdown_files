...
[Warren Cowley Parameter](https://github.com/killiansheriff/WarrenCowleyParameters)软件包可以作为ovito的modifier，也可以通过python接口进行实现。通过python接口自动计算，jieguo1
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNDQ4NzM5NywxODQyMDcwODM0LC0yMT
